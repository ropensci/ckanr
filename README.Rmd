...
```{r}
resource_search(q = 'name:data', as='table', url = nhmbase)
```

```{r}
resource_show(id = "fefa4aca-61e0-4978-9507-040db59c1641", as="table", url = nhmbase)
```
