...
#' res <- resource_show(
#'   id = "6145a539-cbde-4b0d-a3d3-d1a5eb013f5c",
#'   as = "table"
#' )
...
#' res <- resource_show(
#'   id = "c57c3e1c-20e2-470f-bc82-e39a0264be31",
#'   as = "table"
#' )
#' res$url
#' res$format
...
#' ckanr_setup("http://datamx.io")
#' res <- resource_show(
#'   id = "e883510e-a082-435c-872a-c5b915857ae1",
#'   as = "table"
#' )
#' head(ckan_fetch(res$url))
#'
...
#' ckanr_setup()
#' res <- resource_show(
#'   id = "ce02a1cf-35f1-41df-91d9-11ed1fdd4186",
#'   as = "table"
#' )
...
#' res <- resource_show(
#'   id = "80321bac-4283-487c-93bd-c65acaa660f5",
#'   as = "table"
#' )
#' ckan_fetch(res$url)
#' library("xml2")
...
#' res <- resource_show(
#'   id = "8d07c662-800d-4977-9e3e-5a3d2d1e99ab",
#'   as = "table"
#' )
#' head(ckan_fetch(res$url))
#'
...
#' ckanr_setup("https://ckan0.cf.opendata.inter.prod-toronto.ca")
#' res <- resource_show(
#'   id = "27362290-8bbf-434b-a9de-325a6c2ef923",
#'   as = "table"
#' )
#' x <- ckan_fetch(res$url)
#' class(x)
...
#' ckanr_setup("http://datamx.io")
#' res <- resource_show(
#'   id = "b1cd35b7-479e-4fa0-86e9-e897d3c617e6",
#'   as = "table"
#' )
#' x <- ckan_fetch(res$url)
#' class(x)
...
#' ckanr_setup("https://ckan0.cf.opendata.inter.prod-toronto.ca")
#' res <- resource_show(
#'   id = "e4211f49-611f-438c-a444-aaa7f3f84117",
#'   as = "table"
#' )
#' x <- ckan_fetch(res$url)
#' head(x)
...
#' res <- resource_show(
#'   id = "384fe537-e0bd-4e57-8a0d-420b7a745196",
#'   as = "table"
#' )
...
#' ckanr_setup("https://data.coat.no")
#' res <- resource_show(
#'   id = "b7d1c192-0f44-4bab-bd51-eea0d408a09f",
#'   as = "table"
#' )
#' x <- ckan_fetch(res$url)
#' head(x)
#' }
ckan_fetch <- function(
  x, store = "session", path = "file", format = NULL,
  key = get_default_key(), ...
) {
  if (length(x) != 1) {
